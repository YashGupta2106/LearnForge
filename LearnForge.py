...
from pptx.dml.color import RGBColor  # For custom colors
...
def convert_pptx_to_images(pptx_path, images_folder):
    ...
    powerpoint.Visible = 1  # Makes PowerPoint visible (required to avoid errors)
...
def mcq_test(topic, subtopic):
    questions = generate_mcq_questions(topic, subtopic)  # Define this function to get questions
    return render_template('mcq_test.html', questions=questions, topic=topic, subtopic=subtopic)
